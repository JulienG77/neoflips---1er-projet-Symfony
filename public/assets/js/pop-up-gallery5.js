...
$('.wrapper-inner-content-image').each(function() {
	...
	this_element.find('.wrapper-inner-content-image-hover').height(this_element.find('img:first-child').height());
     ...
     var sizeBackground = this_element.find('img:first-child').css('width'); 
     $(this).css({ "background-size":sizeBackground, "background-repeat":"no-repeat", "background-image":"url('"+imgBackground+"')" }); 
